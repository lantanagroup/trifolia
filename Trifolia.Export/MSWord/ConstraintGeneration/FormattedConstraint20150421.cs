...
{
    public class FormattedConstraint20150421 : IFormattedConstraint
    {
            ...
            else
            {
                ...
                if (!string.IsNullOrEmpty(this.ValueConformance))
                {
                    ...
                    if (!string.IsNullOrEmpty(this.ValueSetOid) && !string.IsNullOrEmpty(this.ValueSetName))
                    {
                        ...
                        {
                            this.parts.Add(new ConstraintPart(
                                ConstraintPart.PartTypes.Link, this.ValueSetName) { LinkDestination = Helper.GetCleanName(this.ValueSetName, 39) });
                ...
                if (this.ConstraintReferences != null)
                {
