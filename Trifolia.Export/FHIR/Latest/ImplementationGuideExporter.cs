...
namespace Trifolia.Export.FHIR.Latest
{
    public class ImplementationGuideExporter
    {
        ...
        {
            var url = string.Format("{0}://{1}/api/FHIRLatest/StructureDefinition/{2}",
                this.scheme,
                this.authority,
                template.Id);
            return url;
        ...
        private static string GetResourceName(Resource resource, string defaultName = "")
        {
            ...
            switch (resource.ResourceType)
            {
                case ResourceType.Organization:
                    return ((fhir_latest.Hl7.Fhir.Model.Organization)resource).Name;
                case ResourceType.CapabilityStatement:
                    return ((fhir_latest.Hl7.Fhir.Model.CapabilityStatement)resource).Name;
                case ResourceType.SearchParameter:
                    return ((fhir_latest.Hl7.Fhir.Model.SearchParameter)resource).Name;
                case ResourceType.Group:
                    return ((fhir_latest.Hl7.Fhir.Model.Group)resource).Name;
                case ResourceType.Location:
                    return ((fhir_latest.Hl7.Fhir.Model.Location)resource).Name;
                case ResourceType.Account:
                    return ((fhir_latest.Hl7.Fhir.Model.Account)resource).Name;
            }
