...
<script type="text/javascript" src="/Scripts/angular/filters.js?<%= ViewContext.Controller.GetType().Assembly.GetName().Version %>""></script>
...
<script type="text/javascript" src="/Scripts/angular/treegrid/treegrid.js?<%= ViewContext.Controller.GetType().Assembly.GetName().Version %>""></script>
