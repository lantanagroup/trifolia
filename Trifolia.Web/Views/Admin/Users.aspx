...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Users">
        ...
        <p data-bind="if: TotalPages() > 0">
            <div class="btn-group">
                <button type="button" class="btn btn-default" data-bind="enable: CurrentPage() != 1, click: FirstPage" title="First Page"><i class="glyphicon glyphicon-fast-backward"></i></button>
                <button type="button" class="btn btn-default" data-bind="enable: CurrentPage() != 1, click: PreviousPage" title="Previous Page"><i class="glyphicon glyphicon-backward"></i></button>
                <button type="button" class="btn btn-default" disabled>Page <span data-bind="text: CurrentPage"></span> of <span data-bind="text: TotalPages"></span></button>
                <button type="button" class="btn btn-default" data-bind="enable: CurrentPage() != TotalPages(), click: NextPage" title="Next Page"><i class="glyphicon glyphicon-forward"></i></button>
                <button type="button" class="btn btn-default" data-bind="enable: CurrentPage() != TotalPages(), click: LastPage" title="Last Page"><i class="glyphicon glyphicon-fast-forward"></i></button>
            </div>
        </p>
        ...
        <table class="table table-striped">
            ...
            <tbody data-bind="foreach: PagedUsers">
                <tr>
