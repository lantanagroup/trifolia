...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="ng-cloak" ng-app="Trifolia" ng-controller="ExportCtrl">
        <form method="post" action="{{getPostUrl()}}">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="No implementation guide selected" value="{{selectedImplementationGuide.DisplayName || selectedImplementationGuide.Title}}" readonly="readonly" ng-click="openSearch()" />
            ...
            <div class="form-group">
                ...
                <select class="form-control" ng-model="criteria.selectedExportFormat" ng-options="o.id as o.name for o in getExportFormats()">
                    <option value="">SELECT</option>
                </select>
            </div>

            <uib-tabset ng-if="criteria.selectedExportFormat && selectedImplementationGuide">
                <uib-tab heading="General">
                    <div ng-if="categorySelectionFormats.indexOf(criteria.selectedExportFormat) >= 0" ng-include="'categorySelect.html'"></div>

                    <!-- MS Word Export Options -->
                    <div ng-if="criteria.selectedExportFormat == 'MSW'">
                        <div class="form-group">
                            <label>Sort Order</label>
                            <select class="form-control">
                                <option value="AH">Alpha-Hierarchical</option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control">
                                ...
                                <option>Constraint Overview</option>
                            </select>
                        </div>
                    ...
                    <div ng-if="criteria.selectedExportFormat == 'SCH'">
                        <div class="form-group">
                    ...
                    <div ng-if="vocFormats.indexOf(criteria.selectedExportFormat) >= 0">
                        <div class="form-group">
                            <label>Maximum Members (0 = export all members)</label>
                            <div class="input-group">
                                <input type="text" name="MaximumMembers" class="form-control spinedit noSelect" value="0"><div class="spinedit input-group-addon"><i class="glyphicon glyphicon-chevron-up"></i><i class="glyphicon glyphicon-chevron-down"></i></div>
                            </div>
                        </div>
                ...
                <uib-tab heading="Value Sets" ng-if="vocFormats.indexOf(criteria.selectedExportFormat) >= 0 || criteria.selectedExportFormat == 'MSW'">
                    <div ng-if="criteria.selectedExportFormat == 'MSW'">
                        <div class="form-group">
                            <label>Tables?</label>
                            <input type="radio" name="GenerateValuesets" ng-value="true" ng-model="criteria.valueSetTables">Yes <input type="radio" name="GenerateValuesets" ng-value="false" ng-model="criteria.valueSetTables"> No
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="MaximumValuesetMembers" name="MaximumValuesetMembers" ng-model="criteria.maximumMembers" ng-change="maximumMembersChanged()">
                ...
                <uib-tab heading="Templates/Profiles" ng-if="templateSelectionFormats | contains:criteria.selectedExportFormat">
                    <div class="form-group">
    ...
    <script type="text/html" id="categorySelect.html">
        <div class="form-group" ng-if="categories.length > 0">
            ...
            <select class="form-control" multiple="multiple" ng-model="criteria.selectedCategories" ng-options="o for o in categories"></select>
        </div>
    </script>
