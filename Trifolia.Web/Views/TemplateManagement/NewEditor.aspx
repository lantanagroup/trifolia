...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="editor ng-cloak" ng-app="Trifolia" ng-controller="EditorController" ng-init="init(<%= Model.TemplateIdString %>, <%= Model.DefaultImplementationGuideIdString %>)" block-ui="constraintBlock">
        ...
        <div class="left-nav">
            <button type="button" class="btn btn-default btn-sm" ng-disabled="false" uib-popover-template="'/Scripts/NewTemplateEditor/templateSearch.html'" popover-placement="right" popover-append-to-body="true" popover-class="template-search" popover-trigger="'outsideClick'" popover-is-open="leftNavOpened">Templates/Profiles</button>
        </div>
