...
//Removes the errors array that's added by the validation plugin, avoids unnecessary mapping
ko.mapping.defaultOptions().ignore = ["errors"];
    ...
    var api = (function () {
        ...
        return {
            ...
            insertValidationMessage: function (element) {
                var messageElementId = $(element).attr('messageElementId');
                var messageElement = $("#" + messageElementId);

                if (messageElement.length > 0) {
                    messageElement.addClass(utils.getConfigOptions(element).errorMessageClass);
