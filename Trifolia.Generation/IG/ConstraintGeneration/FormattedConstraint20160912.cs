...
{
    public class FormattedConstraint20160912 : IFormattedConstraint
    {
        public FormattedConstraint20160912()
        {
        ...
        public List<ContainedTemplateInfo> ContainedTemplates { get; set; }
        ...
        public void ParseConstraint(IConstraint constraint)
        {
            ...
            if (constraint.ContainedTemplateIds != null && constraint.ContainedTemplateIds.Count() == 1)
            {
                this.containedTemplate = this.tdb.Templates.Single(y => y.Id == constraint.ContainedTemplateIds.First());
