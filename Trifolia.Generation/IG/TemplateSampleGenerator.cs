...
using Trifolia.Generation.IG.Exceptions;
using Trifolia.DB;

namespace Trifolia.Generation.IG
{
    public class TemplateSampleGenerator
    {
        ...
        private TemplateSampleGenerator(IObjectRepository tdb, Template template)
        {
            this.tdb = tdb;
        ...
        public static TemplateSampleGenerator CreateTemplateSampleGenerator(IObjectRepository tdb, Template template)
        {
            TemplateSampleGenerator lGenerator = new TemplateSampleGenerator(tdb, template);
            return lGenerator;
        }
