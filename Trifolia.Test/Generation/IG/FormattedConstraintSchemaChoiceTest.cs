...
namespace Trifolia.Test.Generation.IG
{
    ...
    public class FormattedConstraintSchemaChoiceTest
    {
        ...
        public void SingleChild()
        {
            ...
            var c1fc = FormattedConstraintFactory.NewFormattedConstraint(this.tdb, this.fhirIgSettings, c1);
            var c1Text = c1fc.GetPlainText();

            var c2fc = FormattedConstraintFactory.NewFormattedConstraint(this.tdb, this.fhirIgSettings, c2);
        ...
        public void MultipleChildren()
        {
            ...
            var c3fc = FormattedConstraintFactory.NewFormattedConstraint(this.tdb, this.fhirIgSettings, c3);
