...
namespace Trifolia.Test.DB
{
    ...
    public class ImplementationGuideExtensionsTest
    {
        ...
        public void GetRecursiveTemplates_ThreeVersions()
        {
            ...
            // Version 1
            var implementationGuide1 = tdb.FindOrCreateImplementationGuide(MockObjectRepository.DEFAULT_CDA_IG_TYPE_NAME, "IG V1");
            var template1 = tdb.CreateTemplate("1.2.3.4", "Document", "Doc Template V1", implementationGuide1, "ClinicalDocument", "ClinicalDocument");

            // Version 2
            var implementationGuide2 = tdb.FindOrCreateImplementationGuide(MockObjectRepository.DEFAULT_CDA_IG_TYPE_NAME, "IG V2", previousVersion: implementationGuide1);

            var template2 = tdb.CreateTemplate("1.2.3.4", "Document", "Doc Template V2", implementationGuide2, "ClinicalDocument", "ClinicalDocument", previousVersion: template1);

            // Version 3
            var implementationGuide3 = tdb.FindOrCreateImplementationGuide(MockObjectRepository.DEFAULT_CDA_IG_TYPE_NAME, "IG V3", previousVersion: implementationGuide2);

            var template3 = tdb.CreateTemplate("1.2.3.4", "Document", "Doc Template V3", implementationGuide3, "ClinicalDocument", "ClinicalDocument", previousVersion: template2);
        ...
        public void GetRecursiveTemplates_ThreeVersions_V3Changed()
        {
            ...
            // Version 3
            var implementationGuide3 = tdb.FindOrCreateImplementationGuide(MockObjectRepository.DEFAULT_CDA_IG_TYPE_NAME, "IG V3", previousVersion: implementationGuide2);
            var template2 = tdb.CreateTemplate("1.2.3.4", "Document", "Doc Template V3", implementationGuide3, "ClinicalDocument", "ClinicalDocument", previousVersion: template1);
        ...
        public void GetRecursiveTemplates_DeprecatedTemplate()
        {
            ...
            var template2 = tdb.CreateTemplate("1.2.3.4", "Document", "Doc Template V2", implementationGuide2, "ClinicalDocument", "ClinicalDocument", previousVersion: template1, status: "Deprecated");
        ...
        public void GetRecursiveTemplates_RetiredTemplate()
        {
            ...
            var template2 = tdb.CreateTemplate("1.2.3.4", "Document", "Doc Template V2", implementationGuide2, "ClinicalDocument", "ClinicalDocument", previousVersion: template1, status: "Retired");
        ...
        public void GetRecursiveTemplates_ContainedInferred_MultiVersions()
        {
            ...
            var externalIG = tdb.FindOrCreateImplementationGuide(MockObjectRepository.DEFAULT_CDA_IG_TYPE_NAME, "External IG");
            var exTemplate1 = tdb.CreateTemplate("4.3.2.1", "Entry", "Ext Entry Template", externalIG, "observation", "Observation");
            ...
            var implementationGuide3 = tdb.FindOrCreateImplementationGuide(MockObjectRepository.DEFAULT_CDA_IG_TYPE_NAME, "IG V3", previousVersion: implementationGuide2);
            var template3 = tdb.CreateTemplate("1.2.3.4", "Document", "Doc Template V3", implementationGuide3, "ClinicalDocument", "ClinicalDocument", previousVersion: template2, status: "Retired");

            // Version 4, retired template should no longer appear
            var implementationGuide4 = tdb.FindOrCreateImplementationGuide(MockObjectRepository.DEFAULT_CDA_IG_TYPE_NAME, "IG V4", previousVersion: implementationGuide3);
