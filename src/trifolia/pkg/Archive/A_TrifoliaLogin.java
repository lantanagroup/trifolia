	  ...
	  //Login to Trifolia Workbench Dev environment as Lantana Administrator 
		 ...
		 if (baseURL == "http://dev.trifolia.lantanagroup.com/")
		 {
			...
			//Enter Username and Password
			 ...
			 driver.findElement(By.xpath("/html/body/div[2]/div/form/div[2]/input")).sendKeys("admin");
			 driver.findElement(By.xpath("/html/body/div[2]/div/form/div[3]/input")).clear();
			 driver.findElement(By.xpath("/html/body/div[2]/div/form/div[3]/input")).sendKeys("tr1fol1atest");
		 }
		 if (baseURL == "http://staging.lantanagroup.com:1234/")
		 {
			...
			//Enter Username and Password
			 ...
			 driver.findElement(By.xpath("//*[@id=\"ctl00_mainBody\"]/div[2]/div/form/div[2]/input")).sendKeys("test.user");
			 driver.findElement(By.xpath("//*[@id=\"ctl00_mainBody\"]/div[2]/div/form/div[3]/input")).clear();
			 driver.findElement(By.xpath("//*[@id=\"ctl00_mainBody\"]/div[2]/div/form/div[3]/input")).sendKeys(".password1"); 
		 }
		  ...
		  if (baseURL == "http://dev.trifolia.lantanagroup.com/")
		   {
			 ...
			 driver.navigate().to("dev.trifolia.lantanagroup.com/Account/Login?debug");
				...
				//Enter Username and Password
			 driver.findElement(By.xpath("/html/body/div[2]/div/form/div[2]/input")).clear();
			 driver.findElement(By.xpath("/html/body/div[2]/div/form/div[2]/input")).sendKeys("user");
			 driver.findElement(By.xpath("/html/body/div[2]/div/form/div[3]/input")).clear();
			 driver.findElement(By.xpath("/html/body/div[2]/div/form/div[3]/input")).sendKeys("tr1fol1atest");
		     driver.findElement(By.xpath("//*[@id=\"ctl00_mainBody\"]/div[2]/div/form/button ")).click();
		   ...
		   else if (baseURL == "http://staging.lantanagroup.com:1234/")  
		   {
			 ...
			 //Enter Username and Password
			 driver.findElement(By.xpath("/html/body/div[2]/div/form/div[2]/input")).clear();
			 driver.findElement(By.xpath("/html/body/div[2]/div/form/div[2]/input")).sendKeys("trifolia.test");
			 driver.findElement(By.xpath("/html/body/div[2]/div/form/div[3]/input")).clear();
			 driver.findElement(By.xpath("/html/body/div[2]/div/form/div[3]/input")).sendKeys("t3st1ngtrif");
			 driver.findElement(By.xpath("//*[@id=\"ctl00_mainBody\"]/div[2]/div/form/button")).click(); 
		   }
 	     ...
 	     
 	     {
		      ...
		      assertTrue("Could not find \"Health Level Seven\" on page.", driver.findElement(By.cssSelector("BODY")).getText().indexOf(hl7Welcome) >= 0);
	  	     ...
	  	     // Enter HL7 Member Username and Password
	  		   driver.findElement(By.xpath("//*[@id=\"ctl00_MainContent_txtUserNameHL7\"]")).sendKeys("student_test");
	  		   driver.findElement(By.xpath("//*[@id=\"ctl00_MainContent_txtPasswordHL7\"]")).sendKeys("password123"); 
 	   ...
 	   //Launch the HL7 Login Page
 	    ...
 	    // switch focus of WebDriver to HL7 QCommerce login page
  	    ...
  	    //Enter HL7 Username and Password
  		   driver.findElement(By.xpath("//*[@id=\"ctl00_MainContent_txtUserNameHL7\"]")).sendKeys("trifolia_test");
  		   Thread.sleep(500);
  		   driver.findElement(By.xpath("//*[@id=\"ctl00_MainContent_txtPasswordHL7\"]")).sendKeys("hl711user"); 
  		   driver.findElement(By.xpath("//*[@id=\"ctl00_MainContent_SubmitHL7\"]")).click();
   ...
   //Lantana Administrator and Lantana User Logout of Trifolia Workbench 
    ...
    public void LCGLogout(String permissionUserName) throws Exception {
    	...
    	if (permissionUserName == "lcg.admin") 
        	{
    		driver.findElement(By.xpath("//*[@id=\"appnav\"]/div/div[2]/ul/li[7]/a")).click();
    		driver.findElement(By.xpath("//*[@id=\"appnav\"]/div/div[2]/ul/li[7]/ul/li[3]/a")).click();
        	...
        	{
        	driver.findElement(By.xpath("//*[@id=\"appnav\"]/div/div[2]/ul/li[5]/a/span")).click();
    		driver.findElement(By.xpath("//*[@id=\"appnav\"]/div/div[2]/ul/li[5]/ul/li[3]/a")).click();
    ...
    @Test
    public void HL7Logout(String hl7Welcome, String baseURL) throws Exception { 	
    		...
    		// Confirm Trifolia Logout is Successful
    		 WebDriverWait wait1 = new WebDriverWait(driver, 60);
    		 WebElement element1 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/h3/a"))); 	       
   	         assertTrue("Logout was not Successful", driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*Welcome to Trifolia Workbench![\\s\\S]*$"));
	           ...
	           // Confirm the HL7 Welcome Page appears
	             ...
	             if (baseURL == "http://dev.trifolia.lantanagroup.com/")
	            	  ...
	            	  WebDriverWait wait3 = new WebDriverWait(driver, 60);                     
	 		  	     wait.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath("/html/body/div[1]/div[1]/div[1]/div[1]"), hl7Welcome));
	 		         assertTrue("Could not find \"Health Level Seven\" on page.", driver.findElement(By.cssSelector("BODY")).getText().indexOf(hl7Welcome) >= 0);  		           
	 		         driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[3]/a")).click();
	   	         	}
