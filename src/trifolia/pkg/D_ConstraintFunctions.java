...
public void FindTemplate(String templateName, String templateOID, String templateIG) throws Exception 
	{
	  ...
	  // Open the Template Browser
		  ...
		  // Confirm Template Browser opens
		   ...
		   wait1.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath("/html/body/div[2]/div/div/table/thead/tr[1]/th[1]"),"Name"));
		   ...
		   wait1.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath("/html/body/div[2]/div/div/div[1]"),"Page 1 of 1, 1 templates/profiles"));
		 
		   // Confirm the correct Template Name is returned
		    WebDriverWait wait3 = new WebDriverWait(driver, 60);                     
		  	wait2.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath("/html/body/div[2]/div/div/table/tbody/tr/td[1]"), templateName));
		    ...
		    WebDriverWait wait4 = new WebDriverWait(driver, 60);                     
		  	wait3.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath("/html/body/div[2]/div/div/table/tbody/tr/td[3]"), templateIG));
...
//TEST 3: Add a Primitive Constraint containing schematron 
 @Test   
   ...
   if (templateType == "eMeasure: Document")
		{  
	    WebDriverWait wait1 = new WebDriverWait(driver, 60);                             
	    WebElement element1 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div[1]/div/div[2]/div[1]/div[2]/div[6]/div[2]/span")));
	 ...
	 //Add Constraint Prose 
	   WebDriverWait wait2 = new WebDriverWait(driver, 60);                             
	   WebElement element2 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div[1]/div/div[2]/div[2]/div[2]/div/div[2]/div/textarea")));
     ...
     //Set Binding Type 
	   ...
	   WebDriverWait wait3 = new WebDriverWait(driver, 60);                                
	   WebElement element3 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div[1]/div/div[2]/div[2]/div[2]/div/div[4]/textarea")));
   	     
	   // Save the template         
	   driver.findElement(By.xpath("/html/body/div[2]/div/div/div[2]/div/div[1]/div[1]/button")).click();
	   driver.findElement(By.xpath("/html/body/div[2]/div/div/div[2]/div/div[1]/div[1]/ul/li[1]/a")).click();
	      
	   //Confirm template was Saved
	   WebDriverWait wait4 = new WebDriverWait(driver, 60);
	   WebElement element4 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"footer\"]/div/div[2]/span")));
	   assertTrue("Could not find \"Done Saving\" on page.", driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*Done saving.[\\s\\S]*$"));
...
// TEST 4: Edit Primitive Constraint, then Duplicate and Delete the Primitive Constraint 
 @Test  
   ...
   if (templateType == "eMeasure: Document")
	   ...
	   WebDriverWait wait2 = new WebDriverWait(driver, 60);                                     
		WebElement element2 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div[2]/div/div[4]/div/select")));
     ...
     // Open the 'id' element       
	   ...
	   if (templateType == "CDA: Document")
		   ...
		   WebDriverWait wait3 = new WebDriverWait(driver, 60);                             
		   WebElement element3 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div[1]/div/div[2]/div[1]/div[2]/div[8]/div[6]/div[6]")));
		  
		 //Select the Primitive Constraint
		    WebDriverWait wait4 = new WebDriverWait(driver, 60);                                     
		    WebElement element4 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div[1]/div/div[2]/div[1]/div[2]/div[8]/div[6]/div[6]")));
	   ...
	   if (templateType == "eMeasure: Document")
			...
			// Confirm the primitive constraint is selectable
			   WebDriverWait wait3 = new WebDriverWait(driver, 60);                             
			   WebElement element3 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div[1]/div/div[2]/div[1]/div[2]/div[7]/div[11]/div[6]")));
			
			// Confirm the primitive constraint appears in the Grid View
				 WebDriverWait wait5 = new WebDriverWait(driver, 60);                    
		  	     wait5.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath("/html/body/div[2]/div/div/div[1]/div/div[2]/div[1]/div[2]/div[7]/div[11]/div[6]"), "SHALL"));
      ...
      // Confirm the primitive constraint appears in the Constraint Editor
	   	 WebDriverWait wait5 = new WebDriverWait(driver, 60);                    
  	     wait5.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath("/html/body/div[2]/div/div/div[1]/div/div[2]/div[2]/div[2]/div/div[2]/div/div[1]/select"), "SHALL"));
      ...
      //Confirm the duplicated element appears and Select the Duplicated primitive constraint
	   if (templateType == "CDA: Document")
		   ...
		   driver.findElement(By.xpath("/html/body/div[2]/div/div/div[1]/div/div[2]/div[1]/div[2]/div[8]/div[7]/div[6]")).click();
			...
			{
		   WebDriverWait wait8 = new WebDriverWait(driver, 60);
		   WebElement element8 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div[1]/div/div[2]/div[1]/div[2]/div[7]/div[12]/div[6]")));
 ...
 @Test
   public void PreviewAndValidateConstraint(String templateName, String templateOID, String constraint1, String constraint2, String constraint3, String constraint4, 
	 ...
	 // Open the Preview Pane
	   ...
	   // Wait for page to fully load
		 WebDriverWait wait20 = new WebDriverWait(driver, 5);		
	   ...
	   WebDriverWait wait12 = new WebDriverWait(driver, 60);               
	   	wait0.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath("/html/body/div[2]/div/div/div[1]"), "Page 1 of 1, 1 templates/profiles"));
